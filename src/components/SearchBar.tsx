...
export function SearchBar({ createTask, ...rest }: SearchBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 w-full max-w-[638px]  absolute -bottom-6 ">
      <input className="w-full h-14 bg-gray-500 text-md rounded-lg border-gray-700 p-4
